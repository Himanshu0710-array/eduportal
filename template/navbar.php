            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav navbar-1">
                        ...
                        <li class="nav-item">
                          <a class="nav-link active" aria-current="page" href="student/register.php">Admission</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link active" aria-current="page" href="../student/login-student.php">Fees</a>
                        </li>
                    </ul>
                </div>
                <div class="navbar-2">
                    <ul class="navbar-nav navbar-2">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="../student/register.php">
                                Register
