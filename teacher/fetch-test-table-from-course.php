...
$stmt=$conn->prepare("SELECT * FROM tbltest WHERE courseId=:courseId");
    ...
    <td>
        <a href="edit-test.php?id=<?php echo $result['id'];?> ">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
             ...
             |
        <a href="delete-test.php?id=<?php echo $result['id']; ?>" style="color: red; text-decoration: none;">
...
<?php
    ...
    echo "<strong>No Record Found For The Selected Course</strong>";
}
?>