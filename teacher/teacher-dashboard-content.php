            ...
            <div class="col-md-2  left-side">
                ...
                <div class="image">
                    ...
                    <?php
                        ...
                        {
                        	if ($result['teacherGender'] == '1') 
                        	{
                        		echo '<img src="images/male-logo.jpg" alt="Male" style="height: 100px; width: 100px;" />';
                        	} 
                        	elseif ($result['teacherGender'] == '2')
                        	{
                        		echo '<img src="images/female-logo.jpg" alt="Female" style="height: 100px; width: 100px;" />';
                        	} 
                        }
                    ?>
                    </a>
                ...
                <div class="buttons">
                    <div class="dropdown ">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <!--<li><a class="dropdown-item w-100" href="result-table.php">Result Table</a></li>-->
                      </ul>
                    </div>
                    <div class="dropdown ">
                      <button class="btn dropdown-toggle w-100 nav-link left-btn" type="button" data-bs-toggle="dropdown" aria-expanded="false">
