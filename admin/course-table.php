            ...
            <table class="table table-hover table-bordered">
              ...
              <tbody>
                ...
                ?>
                    ...
                    <td><?php echo $result['courseId']; ?></td>
                     ...
                     <td>
                        <?php 
                            ...
                            if($result['courseDuration']==1)
                            {
                                echo "1 Year";
                            }
                            else if($result['courseDuration']==2)
                            {
                                echo "2 Years";
                            }
                            else if($result['courseDuration']==3)
                            {
                                echo "3 Years";
                            }
                            else if($result['courseDuration']==4)
                            {
                                echo "4 Years";
                            }
                            else 
                    ...
                    <td>
                        <div class="icons">
                            <a href="edit-course.php?courseId=<?php echo $result['courseId'] ?>">
                            ...
                            |
                            <form action="delete-course.php" method="POST" onsubmit="return confirm('Are you sure you want to delete this course?');">
                                <input type="hidden" name="courseId" value="<?php echo $result['courseId']; ?>">
