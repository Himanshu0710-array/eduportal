  ...
  <body>
    <div class="col-md-10 form-section">
        <form class="fees-content" action="add-test-process.php" method="POST">
            ...
            <div class="mb-3">
                <label for="maximumMarks" class="form-label"><b>Max Marks For The Test</b></label>
                <input class="form-control" type="text" placeholder="Max Marks" name="maximumMarks" id="maximumMarks" value="<?php echo isset($_SESSION['maximumMarks']) ? $_SESSION['maximumMarks'] : ''; ?>" aria-label="default input example" readonly>    
            </div>
...
$(document).ready(function(){
    ...
    $("#courseId, #academicYearId").change(function(){
        ...
        if(courseId == "-1" || academicYearId == "-1") return;
        $.ajax({
