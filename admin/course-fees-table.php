...
$query="SELECT * FROM tblCourseFees";
            ...
            <table class="table table-hover table-bordered">
              <thead>
                <tr>
                    ...
                    <th scope="col">Session Of Course Registration</th>
              ...
              <tbody>
                ...
                ?>
                    ...
                    <td>
                    <?php 
                        $formattedDate = date("d/m/y", strtotime($result['dueDate']));
                        echo $formattedDate;
                    ?>
                    </td>
                    <td>
                        <div class="icons">
                            <a href="edit-course-fees.php?id=<?php echo $result['id']; ?>">
                            ...
                            |
                            <form action="delete-course-fees.php?id=<?php echo $fees['id'] ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this row?');">
