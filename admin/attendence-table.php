            ...
            <div class="col-md-10 content-add-admin">
                ...
                <form class="row" action="attendence-management-process.php" method="POST">
                    ...
                    <div>
                        ...
                        <input class="form-control" type="date" placeholder="DD/MM/YY" value="<?php echo $_SESSION['dateOfAttendence'] ?: date('Y-m-d'); ?>" name="dateOfAttendence" id="dateOfAttendence" aria-label="default input example">    
                    </div>
                    <div class="mb-3">
