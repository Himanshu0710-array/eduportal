            ...
            <table class="table table-hover table-bordered">
              <thead>
                <tr>
                  ...
                  <th scope="col">Admin's Occupation</th>
              ...
              <tbody>
                ...
                ?>
                    ...
                    <td><?php echo textSafe($result['adminName']); ?></td>
                    <td><?php echo $result['adminNumber']; ?></td>
                    <td>
                     
                        <?php 
                     
                            $result['adminOccupation']; 
                            
                            if($result['adminOccupation']==1)
                            {
                                echo "Principal" ;
                            }
                            else if($result['adminOccupation']==2)
                            {
                                echo "HOD" ;
                            }
                            else 
                    ...
                    <td>
                        <div class="icons">
                            <a href="edit-admin.php?adminId=<?php echo $result['adminId'];?>">
