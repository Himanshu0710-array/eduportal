...
if (strlen($studentName) <= 0) {
    header("Location: /admin/manage-student.php?studentId=" . $studentId . "&err=1");
    exit;

}
if (strlen($dob) <= 0) {
    header("Location: /admin/manage-student.php?studentId=" . $studentId . "&err=2");
    exit;

}
if ($courseId == -1) {
    header("Location: /admin/manage-student.php?studentId=" . $studentId . "&err=3");
    exit;

}
if ($sessionId== -1) {
    header("Location: /admin/manage-student.php?studentId=" . $studentId . "&err=4");
    exit;

}
if (strlen($studentNumber) <= 0) {
    header("Location: /admin/manage-student.php?studentId=" . $studentId . "&err=5");
    exit;

}
if ($studentGender == -1) {
    header("Location: /admin/manage-student.php?studentId=" . $studentId . "&err=6");
    exit;

}
if (strlen($studentEmail) <= 0) {
    header("Location: /admin/manage-student.php?studentId=" . $studentId . "&err=7");
    exit;

}
if (strlen($studentPassword) <= 0) {
    header("Location: /admin/manage-student.php?studentId=" . $studentId . "&err=8");
    exit;

}
if (strlen($fatherName) <= 0) {
    header("Location: /admin/manage-student.php?studentId=" . $studentId . "&err=9");
    exit;

}
if (strlen($motherName) <= 0) {
    header("Location: /admin/manage-student.php?studentId=" . $studentId . "&err=10");
    exit;

}
if (strlen($parentNumber) <= 0) {
    header("Location: /admin/manage-student.php?studentId=" . $studentId . "&err=11");
    exit;

}
if (strlen($parentEmail) <= 0) {
    header("Location: /admin/manage-student.php?studentId=" . $studentId . "&err=12");
    exit;

}
if (strlen($dateOfRegistration) <= 0) {
    header("Location: /admin/manage-student.php?studentId=" . $studentId . "&err=13");
    exit;

}
if (strlen($address) <= 0) {
    header("Location: /admin/manage-student.php?studentId=" . $studentId . "&err=14");
    exit;
