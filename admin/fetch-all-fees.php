...
$stmt=$conn->prepare("SELECT * FROM tblfees");
$stmt->execute();
        ...
        ?>
            ...
            <td>
                <div class="icons">
                    ...
                    |
                    <form action="delete-fees.php?feeId=<?php echo $result['feeId'] ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this row?');">
