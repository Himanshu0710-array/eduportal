...
<html lang="en">
  <head>
    ...
    <div class="col-md-10 form-section">
        <body>
            <form class="fees-content" action="add-subject-process.php" method="POST">
                ...
                <div>
                    ...
                    <input class="form-control" type="text" placeholder="Subject Name" name="subjectName" aria-label="default input example">    
                </div>
                <div class="mb-3">
