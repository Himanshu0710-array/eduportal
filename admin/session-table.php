              ...
              <tbody>
                ...
                ?>
                    ...
                    <td><?php echo $result['sessionId']; ?></td>
                     <td><?php echo textSafe($result['sessionName']); ?></td>
                     <td>
                        <?php 
                            if ($result['status'] == 1) {
                    ...
                    <td>
                        <a href="update-session.php?sessionId=<?php echo $result['sessionId'];?>">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                             ...
                             |
                        <a href="delete-session.php?studentId=<?php echo $result['sessionId']; ?>" style="color: red; text-decoration: none;">
