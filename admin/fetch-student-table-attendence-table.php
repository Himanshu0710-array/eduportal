...
while($result=$stmt->fetch())
{
 ...
 <tr>
    ...
    <td>
        ...
        if ($att == 1) {
            echo '<span class="present-btn" style="color: green;">Present</span>';
        } else {
            echo '<span class="absent-btn" style="color: red;">Absent</span>';
        }
        ?>
    </td>
    ...
    <td>
        <a href="edit-attendence.php?studentId=<?php echo $result['studentId']; ?>&subjectId=<?php echo $result['subjectId']; ?>">
